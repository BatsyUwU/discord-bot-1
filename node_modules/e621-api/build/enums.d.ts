export declare enum e621ResponseCodes {
...
export declare enum e621TagTypes {
...
export declare enum e621TagStrings {
    'general' = 0,
    'artist' = 1,
    'copyright' = 2,
    'character' = 3,
...
export declare enum e621PopularityEndpointTypes {
...
export declare enum e621PopularityStrings {
    'daily' = 0,
    'weekly' = 1,
    'monthly' = 2,
    'alltime' = 3
}
export declare enum e621RelatedTagArrayTypes {
    'name' = 0,
    'count' = 1,
    'type' = 2
}
export declare enum e621UserLevels {
    'Unactivated' = 0,
    'Blocked' = 10,
    'Member' = 20,
    'Privileged' = 30,
...
export declare enum e621ForumPostReasons {
    'General' = 1,
