...
var Posts = /** @class */ (function () {
    function Posts(pageLimit, requestServices) {
     ...
     * @memberof e621
     */
    Posts.prototype.checkIfExists = function (md5String) {
     ...
     * @memberof e621
     */
    Posts.prototype.getDeletedIndex = function (page, userID) {
     ...
     * @memberof Posts
     */
    Posts.prototype.revertTags = function (postID, tagHistoryID) {
        var url = "https://e621.net//post/revert_tags.json";
     ...
     * @memberof Posts
     */
    Posts.prototype.vote = function (postID, score) {
     ...
     * @memberof Posts
     */
    Posts.prototype.generatePostUrl = function (postID) {
     ...
     * @memberof e621
     */
    Posts.prototype.getPopularPosts = function (typeArg) {
        var url;
        switch (typeArg) {
            case 0:
     ...
     */
    Posts.prototype.getByID = function (postID) {
     ...
     */
    Posts.prototype.getByMD5 = function (md5String) {
     ...
     * @memberof e621
     */
    Posts.prototype.getIndexPaginate = function (tags, start, limitPerPage, pageLimit) {
        var tagsString;
        var pageStart;
        var limitString;
        var pageLimitTemp;
     ...
     * @memberof Posts
     */
    Posts.prototype.getTagHistoryByID = function (postID, returnJSON) {
        var url = "https://e621.net/post_tag_history/index.json?post_id=" + postID;
        return this.requestServices.get(url)
            .then(function (response) {
            return response;
        })
     ...
     * @memberof Posts
     */
    Posts.prototype.getFavorites = function (postID) {
        var url = "https://e621.net/favorite/list_users.json?id=" + postID;
        return this.requestServices.get(url)
            .then(function (response) {
            return response;
        })
